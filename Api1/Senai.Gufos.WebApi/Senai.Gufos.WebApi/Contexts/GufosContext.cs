...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=localhost; Initial catalog= M_Gufos; User Id=sa; Pwd=132");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categorias>(entity =>
            {
                ...
                entity.HasIndex(e => e.Nome)
                    .HasName("UQ__Categori__7D8FE3B25FA46911")
                    .IsUnique();
            ...
            modelBuilder.Entity<Eventos>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCategoriaNavigation)
                    ...
                    .HasConstraintName("FK__Eventos__IdCateg__778AC167");
            });
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D105342A6C5865")
                    .IsUnique();
