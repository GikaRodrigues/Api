        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Departamentos>(entity =>
            {
                ...
                entity.HasIndex(e => e.Departamento)
                    .HasName("UQ__Departam__71BEBBD7D449044C")
                    .IsUnique();
            ...
            modelBuilder.Entity<Funcionarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cpf)
                    .HasName("UQ__Funciona__C1F897317A71779F")
                    .IsUnique();

                entity.HasIndex(e => e.Funcionario)
                    .HasName("UQ__Funciona__8040ADB360A840D0")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdCargoNavigation)
                    ...
                    .HasConstraintName("FK__Funcionar__IdCar__5812160E");

                entity.HasOne(d => d.IdDepartamentoNavigation)
                    .WithMany(p => p.Funcionarios)
                    .HasForeignKey(d => d.IdDepartamento)
                    .HasConstraintName("FK__Funcionar__IdDep__571DF1D5");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Funcionarios)
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__Funcionar__IdUsu__59063A47");
            });
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D105342E63EEC7")
                    .IsUnique();
